...
For example, the methods explored by \citet{bommasani-etal-2020-interpreting, vulic-et-al-2020-multisimlex} are either shown to work well only for monolingual context models (which are not available for all of our languages), or only for English and multilingual models.}  However, there is evidence from the literature in unsupervised part-of-speech tagging \citep{he-et-al-2018-unsupervised,lin-etal-2015-unsupervised} and probing \citep{pimentel-etal-2020-information, babazhanova-et-al-2021-geometric} that they also encode syntactic information.\footnote{Indeed, our own results suggests that these vectors encode some syntactic information, and that the addition of gold-standard syntactic category information provides little benefit over our proposed model. For further information, please see Sections~\ref{sec:synpotential} and~\ref{sec:synoracle}.}
